 ...
 * 
 * Separated from page.tsx because this uses useSearchParams()
 * which requires a Suspense boundary for static rendering.
 * 
 * Features:
 * - My Purchases uses event indexing (getLogs)
 * - Payment History tab
 * - Store link sharing
 * - URL tab parameter (?tab=purchases)
 */
...
import { useStore, shareStoreUrl } from '@/lib/hooks/use-store';
